...
class CreateDzWhatsappNotificationsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up ()
    {
        Schema::create('dz_whatsapp_notifications', function (Blueprint $table) {
            ...
            $table->foreign('template_id')->references('id')->on('dz_whatsapp_templates');
    ...
    {
        Schema::dropIfExists('dz_whatsapp_notifications');
    }
}
